...
class PrepareDatasetForLearning:
    ...
    def split_multiple_datasets_classification(self, datasets, class_labels, matching, training_frac, for_cv = False,
                                               filter=False, temporal=False, unknown_users=False, random_state=0,
                                               fillna=False):
        training_set_X = None
        training_set_y = None
        test_set_X = None
